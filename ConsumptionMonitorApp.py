...
class ConsumptionMonitorApp(App):
    ...
    def OBDRepair_thread(self):
        ...
        # Liste mit den Dongel-Initialisierungs-Befehlen und den zugehörigen Ausgabe-Texten
    ...
    # Und schreibe den geänderten Wert in die StartData-datei, wen diese schon angelegt wurde.
    # self          --> Handel zur App
    ...
    def SetzeEingabewert(self, EingabeWert):
        ...
        # Wenn StartData-datei gültig ist, werden die Datensätze aktualisiert
